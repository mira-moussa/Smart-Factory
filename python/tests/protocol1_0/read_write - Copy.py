...
while 1:
    ...
    # Write goal position
    dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, DXL_ID, ADDR_MX_GOAL_POSITION, dxl_AX1_pick,50)
    if dxl_comm_result != COMM_SUCCESS:
        print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
    elif dxl_error != 0:
        print("%s" % packetHandler.getRxPacketError(dxl_error))
    ...
    print("[ID:%03d] GoalPos:%03d  PresPos:%03d" % (DXL_ID, dxl_AX1_pick, dxl_present_position))
